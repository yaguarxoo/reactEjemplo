...
import logo from '.././ropa_y_blancos_2.png';
...
const HeaderNuevo = () => {
    return (
        ...
        <header className="navbar navbar-expand-md navbar-dark bd-navbar prueba">
  <nav className="container-xxl flex-wrap flex-md-nowrap" aria-label="Main navigation">
    <a className="navbar-brand p-0" href="/" aria-label="Bootstrap">
    <div className=" class-logo"><img src={logo} alt="logo" /></div>
    </a>
  ...
  <path fillRule="evenodd" d="M2.5 11.5A.5.5 0 0 1 3 11h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4A.5.5 0 0 1 3 7h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4A.5.5 0 0 1 3 3h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z"></path>
    ...
    <div className="collapse navbar-collapse" id="bdNavbar">
      <ul className="navbar-nav flex-row flex-wrap bd-navbar-nav pt-2 py-md-0">
        ...
        <li className="nav-item col-6 col-md-auto">
          <a className="nav-link p-2 active" aria-current="true" >To do list</a>
        </li>
        <li className="nav-item col-6 col-md-auto">
          <a className="nav-link p-2" href="https://icons.getbootstrap.com/">Icons</a>
        </li>
        <li className="nav-item col-6 col-md-auto">
          <a className="nav-link p-2" href="https://themes.getbootstrap.com/">Themes</a>
        </li>
        <li className="nav-item col-6 col-md-auto">
          <a className="nav-link p-2" href="https://blog.getbootstrap.com/">Blog</a>
        </li>
      </ul>
      ...
      <ul className="navbar-nav flex-row flex-wrap ms-md-auto">
        <li className="nav-item col-6 col-md-auto">
          <a className="nav-link p-2" href="https://github.com/twbs" target="_blank" rel="noopener">
